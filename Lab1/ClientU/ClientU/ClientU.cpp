...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	//string IP = "25.36.11.121";	///"192.168.43.59";
	string IP = "25.36.11.121";	///"192.168.43.59";
	int Tc = 1000;
...
#pragma endregion
		...
		for (int i = 0; i < 10; i++)
		{
			...
			auto c = std::chrono::duration_cast<std::chrono::milliseconds>(now.time_since_epoch()).count();

			getsincro.curvalue = c;
			...
			//int l = c - getsincro.curvalue;

			//cout << l << endl;
			cout << setsincro.curvalue << endl;
